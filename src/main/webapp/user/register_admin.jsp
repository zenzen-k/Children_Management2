              ...
              <div class="card-body">
                ...
                <form class="row g-3">
                  <div class="col-12">
                    ...
                    <input type="text" name="" class="form-control" id="yourName">
                  ...
                  <div class="col-12">
                    <label for="yourUsername" class="form-label" style="display: block;">주민등록번호</label>
                    <input type="text" name="" class="form-control" id="yourUsername" style="display: inline; width: 45%">
                    -
                    <input type="text" name="" class="form-control" id="yourUsername" style="display: inline; width: 45%">
                    <div class="invalid-feedback"></div>
                  </div>
                  ...
                  <div class="col-12">
                    ...
                    <input type="email" name="" class="form-control" id="yourEmail">
                    <div class="invalid-feedback"></div>
                  </div>
                  
                  <div class="col-12">
                    <label for="yourUsername" class="form-label" style="display: block;">전화번호</label>
                    <input type="text" name="" class="form-control" id="yourUsername" style="display: inline; width: 30%">
                    -
                    <input type="text" name="" class="form-control" id="yourUsername" style="display: inline; width: 30%">
                    -
                    <input type="text" name="" class="form-control" id="yourUsername" style="display: inline; width: 30%">
