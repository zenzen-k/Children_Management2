					...
					<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
						...
						<div class="card mb-3">
							...
							<div class="card-body">
								...
								<form class="row g-3" action="<%=path%>/user/searchPw_Proc.jsp" method="post">
									
									<div class="col-12">
					                    <label for="yourId" class="form-label">아이디</label>
					                    <input type="text" name="id" class="form-control" id="yourId" onkeydown="keyNone()">
									...
									<div class="col-12">
										<button class="btn btn-primary w-100" type="submit" onclick="return Chk()">찾기</button>
									</div>
								</form>
